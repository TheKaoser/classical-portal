 ...
 * The embed player lives in a root provider so client navigations do not
 * unmount it or clear an active play request.
 */

/** Phase reported by the embed queue (plus connecting/idle). */
...
/** Map an embed `isPaused` flag onto the album Play control. */
