...
export const PERIOD_ICONS: Record<string, IconMark[]> = {
  ...
  "early-romantic": [
    { kind: "path", d: "M12 20.7V12.5" },
    { kind: "path", d: "M12 12.3C9.6 12.3 8.6 9.5 9.4 7.5 10 5.9 11.2 5.3 12 6.7 12.8 5.3 14 5.9 14.6 7.5 15.4 9.5 14.4 12.3 12 12.3Z" },
    { kind: "path", d: "M10.3 12.2C10.8 13.5 13.2 13.5 13.7 12.2" },
    { kind: "path", d: "M12 16.4C9.6 15.7 8.4 16.9 9 18.3 10.4 17.7 11.4 17 12 16.4" },
  ],
  romantic: [
    ...rose(12, 8.8, 2.15),
  ...
  "late-romantic": [
    ...rose(10.2, 8.2, 2.35),
    { kind: "circle", cx: 10.2, cy: 8.2, r: 1.05, fill: true },
    { kind: "path", d: "M10.2 13.2C10.6 16 13.4 16.6 15.2 15.2 17.2 13.6 16.4 11.4 14.8 12.2" },
    { kind: "path", d: "M12.4 16.2C14.8 18.4 16.6 18.2 17.6 16.8" },
    { kind: "path", d: "M9.2 15.4C7.2 16.2 6.2 17.6 6.8 18.8" },
  ],
  "20th-century": [
